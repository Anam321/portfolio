<script type="text/javascript">
    ...
    function listpuisi() {
        ...
        $('#datapuisi').empty();
        $.ajax({
            url: "<?php echo site_url('administrasi/post_puisi/list_puisi/') ?>",
            type: "POST",
            dataType: "JSON",
    ...
    function musikal() {
        ...
        $('#datapuisi').empty();
        $.ajax({
            url: "<?php echo site_url('administrasi/post_puisi/musikal/') ?>",
            type: "POST",
            dataType: "JSON",
            success: function(data) {
                $('#datapuisi').html(data);
    ...
    function lihat(id) {
        $('#datapuisi').empty();
        $.ajax({
            url: "<?php echo site_url('administrasi/post_puisi/lihat_puisi/') ?>" + id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
                $('#datapuisi').html(data);
    ...
    function addpuisi() {
        ...
        $('#modalpuisi').modal('show');
        $('.modal-title').text('Tambah puisi');
    }
    ...
    $('#form').submit(function(e) {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('administrasi/post_puisi/input_puisi') ?>";
        } else {
            url = "<?php echo site_url('administrasi/post_puisi/update_puisi') ?>";
        }
        $.ajax({
            url: url,
            type: "POST",
    ...
    function hapus(id) {
        if (confirm('Apakah Anda yakin menghapus data ini ?')) {
            ...
            $.ajax({
                url: "<?php echo site_url('administrasi/post_puisi/delete_data/') ?>" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
                    if (data.status == '00') {
