...
<html lang="en">
    ...
    <head>
        ...
        <!-- third party css -->
        <link href="<?= base_url() ?>assets/backend/css/vendor/dataTables.bootstrap5.css" rel="stylesheet"
            type="text/css">
        <link href="<?= base_url() ?>assets/backend/css/vendor/responsive.bootstrap5.css" rel="stylesheet"
            type="text/css">
