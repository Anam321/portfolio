            ...
            foreach ($list as $row) {
                ...
                <div class="card-body">
                    ...
                    <div class="text-start mt-3">
                        ...
                        <p class="text-muted mb-2 font-13"><strong>Jenis Kelamin:</strong> <span class="ms-2">' . $row['kelamin'] . '</span></p>
                        <p class="text-muted mb-2 font-13"><strong>Tanggal Lahir :</strong> <span class="ms-2">' . $row['tgl_lahir'] . '</span></p>
